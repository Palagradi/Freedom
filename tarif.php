	...
	require("config.php");
		...
		if (isset($_POST['Envoyer']) and $_POST['Envoyer']=="Ajouter")
			{if(!empty($_POST['typeC']) )
					{ $pre_sql1="INSERT INTO tarifChambres VALUES(NULL,'".ucfirst($_POST['typeC'])."','".$_POST['NbrePers']."')";
...
<div class="container" style='background-color:#84CECC;'>
	<div class="row">
        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3" style='margin-top:-1px;'>
           		<form method="post" action="tarif.php" onSubmit="refreshParent()">
				...
				<?php	
				   echo "								
							<tr>
								<td>
									<fieldset> 
										<legend align='center' style='color:#2F574D;'><b> Enrégistrer un nouveau Tarif</b></legend> 
										<span style='color:#573E39;'> Exemple : Tarif triple </span>
										<table style='font-size:1.1em;'> 
											<tr> 
												<td style='font-size:1.1em;'>  Numéro : </td><input type='hidden' name='numero' value='' /><input type='hidden' name='' id=''  />
												<td style='font-size:1.1em;'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='edit1' id='edit1'  value='00003'  readonly /> </td>		
											</tr> 
											<tr> 
												<td style='font-size:1.1em;'> Nom du Tarif :  </td>
												<td style='font-size:1.1em;'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' style='' name='typeC' id='edit2'  value='' required='required' /> </td>
											</tr>
											<tr> 
												<td style='font-size:1.1em;'> Nbre d'occupants :  </td>
												<td style='font-size:1.1em;'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='number' min='0' max='100' id='' name='NbrePers' style='font-family:sans-serif;font-size:90%;' value='1' value='' required='required' /> </td>
											</tr>
										</table> 
									</fieldset> 
								</td>
