...
function addNumTVA($tva)
{
	...
	$this->Cell(40, 4, "NATURE DE LA FACTURE", '', '', "C");
	$this->SetFont( "Arial", "", 10);
...
function addCols( $tab )
{
	...
	$r2  = $this->w - ($r1 * 2) ;
	$y1  = 100;
	$y2  = $this->h - 55 - $y1;    // Pour augmenter la hauteur du tableau  ->               $y2  = $this->h - 50 - $y1;
	$this->SetXY( $r1, $y1 );
...
function addCadreTVAs()
{
	...
	$r1  = 10;
	$r2  = $r1 + 60;
	$y1  = $this->h - 45;         // Envoyer le tableau en haut            $y1  = $this->h - 40;
	$y2  = $y1+20;
...
//$this->Cell(20,4,' ', 0, 0, "C"); 
	$this->Image($img,$r1, $y1+2, ($r2 - $r1), ($y2-$y1));
	$this->SetXY( $r1, $y1+16 ); 	
	//$this->Ln(20);
	$this->Cell(20,4,'', 0, 0, "C"); 
