...
{  	function temporaire( $texte )
	...
	// $this->SetXY( $x, $y+75 );
		...
		if($_SESSION['FV']>0)
			...
			$this->fact_dev("FACTURE D'AVOIR N° ",""); 
...
/* 
		...
		$this->addPageNumber($_SESSION['initial_fiche']);  // TOTAL TTC
...
/* 		$this->SetXY( $this->GetX()-115, $this->GetY()+35 ); $this->SetTextColor (45); 
		...
		//$this->addNumTVA("Hébergement");
		$this->addNumTVA("Transaction numérique");
		//$this->Ln('10');
		}
...
/* 			if(isset($_SESSION['DT_HEURE_MCF'])) {
	...
	$taux_tva =12;
        ...
        {    $Xo=0; $Yo=0; if(isset($_SESSION['Apply_AIB'])) { $Xo+=6; $Yo+=6; }
			...
			$this->SetXY( 143, $y+10+6+6+6+6+$Yo ); $this->Cell( 25, 6, "Remise accordée", 0, 0, 'R');
