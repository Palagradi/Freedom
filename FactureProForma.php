...
echo '<page backtop="5%" backbottom="5%" backleft="5%" backright="5%">
	...
	echo '</h4>
			...
			<td style="width:10%;" ROWSPAN=2 align="center">Taxe <br/>de<br/> nuitées</td>
			<td style="width:10%;" ROWSPAN=2 align="center">Prix Unitaire<br/> TTC</td>
			<td style="width:50%;" COLSPAN=4 align="center">'; echo 'MONTANTS'; echo '</td>
		</tr>
...
/* 					if($data['occupation']=="individuelle") $taxe=$Mtaxe*$nbre_jrs*$data['Nbre'];
			...
			echo '
				...
				if(($debut!=1) || ($fin!=1))
					...
					<td  align="center">'.$TmontantTVA.'</td>
					<td  align="center">'.$Ttaxe.'</td>
