...
Calendar.prototype.show = function() {
	...
	this.wwrite("<A HREF=\"" +
		...
		");" +
		"\"><font size=1><img src='images/arrow_bl.gif' border='0' alt='année précédente' title='année précédente'/></font><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><font size=1><img src='images/arrow_b.gif' border='0' alt='mois précédent' title='mois précédent'/></font><\/A></TD><TD ALIGN=center>");
	//this.wwrite("<A HREF=\"javascript:window.print();\"><font size=1><img src='images/print.gif' border=0/></font></A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><font size=1><img src='images/arrow_n.gif' border='0' alt='mois suivant' title='mois suivant'/></font><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><font size=1><img src='images/arrow_nl.gif' border='0' alt='année suivante' title='année suivante'/></font><\/A></TD></TR></TABLE><BR>");
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#9F8856'><TR><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', null, '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\" alt='Prev Year'><font size=1><img src='images/arrow_bl.gif' border=0/></font><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"javascript:window.print();\"><font size=1><img src='images/print.gif' border=0/></font></A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', null, '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><font size=1><img src='images/arrow_nl.gif' border=0/></font><\/A></TD></TR></TABLE><BR>");
...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendar", 
		"width=200,height=200,status=no,resizable=no,top=250,left=250");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
...
function format_date(date_entree){

return (date_entree.substr(6, 4).date_entree.substr(3, 4).date_entree.substr(0, 4))
}