					...
					if(($rat['somme']==0)&&($rat['due']==0))
						{
							...
							echo 'alertify.success("L\'occupant a été supprimé de la liste journalière des occupants.");';
							echo "</script>";
						}
					else
						{
						...
						{ if($cpteur == 1)
								...
								else
								{
									...
									$bgcouleur = "#dfeef3";
										...
										echo"<tr class='rouge5' bgcolor='".$bgcouleur."'>";?>
