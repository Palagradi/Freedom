...
?>	<body style='background-color:#84CECC; '>
	<form action='admin.php' method='post' id="chgdept" >
	<table align='center' width='45%' height='auto' border='0' cellpadding='0' cellspacing='0' style='margin-top:8%;border:2px solid teal;font-family:Cambria;background-color:#f5f5dc;'>
		<tr>
			<td align='center' ><h3>SELECTION DE MODULE(S) A INSTALLERxx</h3></td>
		</tr>
		...
		</tr>	<tr>   <td align='center'  style="" >&nbsp;	</td></tr>	
		<tr>	<td align='center'  style="" >
		...
		<tr>	<td align='center'  style="" > <br/><input class='bouton5' type="submit" name="Envoyer" value="Activer" style='margin-bottom:25px;'/> 
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class='bouton6' type="submit" name="Envoyer" value="Désactiver" style='margin-bottom:25px;'/> 		</td>	</tr>
	</table>
	</form>
	</body>
