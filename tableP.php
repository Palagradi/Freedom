	...
	if($Nbre<10) $i="0".$Nbre; else $i=$Nbre;
		...
		if (isset($_POST['Envoyer']) and $_POST['Envoyer']=="Ajouter")
			{if(!empty($_POST['edit1']) )
					{  $pre_sql1="INSERT INTO RTables VALUES('".$_POST['edit1']."','".$_POST['edit2']."','".$_POST['edit3']."')";
...
<div class="container" style='background-color:#84CECC;'>
	<div class="row">
        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3" style='margin-top:-1px;'>
           		<form method="post" action="tableP.php" >
		 ...
		 <?php
					   echo "
								<tr>
									<td>
										<fieldset>
											<legend align='center' style='color:#2F574D;'><b>  Enrégistrement d'une table</b></legend>
											<table style=''>
												<tr>
													<td style='font-size:1.2em;'> N° de la table : </td><input type='hidden' name='numfiche' value='' /><input type='hidden' name='MontantUnites' id='MontantUnites' value='' />
													<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' name='edit1' id='edit1'  value='".$i."' required='required' /> </td>
												</tr>
												<tr>
													<td style='font-size:1.2em;'> Nbre de Couverts : </td>
													<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='number' min='0' max='100' id='' name='edit2' style='' value='1' onkeypress='testChiffres(event);' required='required'/> </td>
												</tr>
												<tr>
