...
<html>
	...
	<form name="sortie.php" method="post" id="form">
		<table align='center'>
			<tr>
				<td><hr noshade size=3> <div align="center"><B>
					...
					<input class='bouton2' type='button' name='<?php  echo "LIBERER";   ?>' value='<?php echo "LIBERER";  ?>'
					<?php echo 'onclick="confirmation();"'; //echo 'onclick="if(!confirm(\'Cette action est irréversible. Voulez-vous vraiment continuer?\')) return false;"'; ?>  
